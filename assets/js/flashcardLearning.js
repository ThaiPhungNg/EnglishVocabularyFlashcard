...
function createFlipCard(data,id) {
              ...
              <div class="frontContainerCard">
                ...
                <div class="ps-4 m-3">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input yes-checked" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                    <label class="form-check-label" for="inlineRadio1">Know it</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input no-checked" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
...
for(let i = 0;i < cardData.length;i++ ){
    let dataId ="box";
    dataId += i.toString();
    const card = createFlipCard(cardData[i],dataId);
